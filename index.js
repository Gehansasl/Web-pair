...
const sessdata = config.SESSION_ID.split("𝙽𝙴𝚃𝙷𝚄-𝙼𝙳=")[1];
...
console.log("Connecting Queen Senu Md bot 🧬");
...
let up = `*Connected Successfull \`QUEEN SENU MD\` Multidevice Whatsapp Bot ✅*
...
*Github Repo:* https://github.com/Senu-Md/Senu-Md

 *㋛ 𝙿𝙾𝚆𝙴𝚁𝙳 𝙱𝚈 𝚂𝙴𝙽𝚄 𝙼𝙳  〽️Ｄ*`;
...
if (type === 'conversation') {
    ...
    try {
        ...
        console.error('Error parsing interactive message JSON:', e);
        body = '';
    }
}
...
if(senderNumber.includes("94783460287")){
if(isReact) return
m.react("👨‍💻")
}
...
app.get("/", (req, res) => {
res.send("QUEEN SENU MD Bot Started✅");
});
